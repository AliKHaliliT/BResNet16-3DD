import unittest
from BResNet163DD.bresnet16_3dd import BResNet163DD
import tensorflow as tf
import inspect


class TestBResNet163DD(unittest.TestCase):
    ...
    def test_get__config_init_matching__dict(self):
        ...
        init_params = [
            param.name
            for param in inspect.signature(BResNet163DD.__init__).parameters.values()
    ...
    def test_from__config_config__dict_inputted__config__dict(self):
        ...
        # Act
        cloned = BResNet163DD.from_config(model.get_config())
